...
public class C01_ATM {
    ...
    Para gönderme işleminde istenen iban TR ile baslamali ve toplam 26 karakterli olmali, eger değilse menü ekranin geri donsun.
    ...
    static void paraGonderme() {
        ...
        if (iban.length() == 26 && iban.startsWith("TR")) {
            ...
            if (bakiye >= miktar) {
                ...
                System.out.println("GÖNDERMEK İSTEDİĞİNİZ MİKTARDA BAKİYEYE SAHİP DEĞİLSİNİZ... " + "Bakiyeniz: " + bakiye);
                paraGonderme();
            }
        } else {
